...
4. Installing Repo compatibility. Recommend doing 4 separate commands here:
```bash
...
If you use a cloud service, see step #3 in the above link. You MUST save your id_rsa in root dir, NOT in ~/home! (cat /root/.ssh/id_rsa.pub)
